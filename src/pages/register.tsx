...
export default function RegisterPage() {
  ...
  return (
    <>
      <Seo
        title="Sign Up - AdMake AI"
        description="Create your AdMake AI account and start generating stunning AI-powered advertisements today."
        noIndex
      />
      ...
      <div className="min-h-screen bg-gradient-to-b from-orange-50 to-white flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          ...
          <p className="mt-2 text-center text-gray-600">
            ...
            <Link href={routes.auth.login} className="text-orange-500 hover:text-orange-600 font-medium">
              Sign in
            </Link>
          </p>
        </div>
          ...
          <div className="bg-white py-8 px-4 shadow-xl rounded-2xl sm:px-10">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="text-sm text-gray-600">
                ...
                <Link href={routes.resources.termsOfService} className="text-orange-500 hover:text-orange-600">
                  Terms of Service
                </Link>{" "}
                and{" "}
                <Link href={routes.resources.privacyPolicy} className="text-orange-500 hover:text-orange-600">
                  Privacy Policy
                </Link>
              </div>
